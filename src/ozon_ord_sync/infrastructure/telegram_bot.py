...
START_TEXT = (
    ...
    "Как пользоваться:\n"
    "1. Выполните /set_token <OZON_ORD_COOKIE>\n"
...
def _translate_error_text(text: str) -> str:
    ...
    replacements = {
        ...
        "Ozon anti-bot challenge required": "Ozon запросил anti-bot challenge. Откройте ORD в браузере, пройдите проверку и попробуйте снова.",
